...
/**
 * Registers Simulacra's Ponder scenes. Client-only, so it is reached exclusively from
 * {@link studio.akuro.simulacra.client.SimulacraClient}.
 *
 ...
 * schematic path under {@code assets/simulacra/ponder/}. Kept as the same string per scene.
 */
public class SimulacraPonderPlugin implements PonderPlugin {
    ...
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        // The least discoverable step in the loop, so it gets its own scene on the item.
        ...
        // Predictions are spent here, so the Prediction item carries the scenes too.
